...
const OrderHistory = ({ compras }) => {
    ...
    const handleUserProfileClick = (user) => {
        ...
        setIsOpen(true); // Mostrar el modal al hacer clic
    };
        ...
        <Layout>
            <div className="mx-auto max-w-7xl lg:px-8 my-4">
                <div className="mx-auto lg:max-w-4xl lg:px-0 mb-4">
                    <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-200">Historial de compras</h1>
                                        ...
                                        <li key={compraProducto.id} className="rounded-lg border mt-4 p-4 shadow-sm border-neutral-700 bg-neutral-800 md:p-6">
                                            <div className="space-y-4 md:flex md:items-center md:gap-6 md:space-y-0">
                                                <a href="#" className="shrink-0 md:order-1">
                                                    <img className="h-20 w-20 rounded-lg" src={compraProducto.producto.foto_prod} alt={`${compraProducto.producto.nombre_prod} image`} />
                                                </a>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                        <div className="bg-white rounded-lg p-6 shadow-lg max-w-sm">
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <button onClick={closePopup} className="mt-4 px-4 py-2 bg-red-500 text-white rounded-lg">Cerrar</button>
                            </div>
                        </div>
                    </div>
                )}
